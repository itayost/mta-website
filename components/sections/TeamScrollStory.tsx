...
const segments: { title: string; body: string; visual: VisualType }[] = [
  ...
  {
    title: '50 שנות ניסיון, פנים לעתיד',
    body: 'המשרד שלנו פועל בהצלחה מעל 50 שנה, אך לעולם אינו קופא על השמרים. שילבנו את הניסיון העשיר שצברנו עם הדינמיות והטכנולוגיה של דור ההמשך. הצוות שלנו פועל מתוך מקצוענות, אדיבות, וידע רחב במגוון תחומי עיסוק במשק. אנחנו גאים ללוות קשת רחבה של לקוחות: עצמאיים, חברות, שותפויות, יזמים בתחילת דרכם, עמותות ומוסדות ציבור.',
    visual: 'sami',
  },
  {
