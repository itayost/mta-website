...
const segments: { title: string; body: string; visual: VisualType }[] = [
  ...
  {
    title: '57 שנות ניסיון, פנים לעתיד',
    body: 'המשרד שלנו פועל בהצלחה מעל 57 שנה, אך לעולם אינו קופא על השמרים. שילבנו את הניסיון העשיר שצברנו עם הדינמיות והטכנולוגיה של דור ההמשך. הצוות שלנו פועל מתוך מקצוענות, אדיבות, וידע רחב במגוון תחומי עיסוק במשק. אנחנו גאים ללוות קשת רחבה של לקוחות: עצמאיים, חברות, שותפויות, יזמים בתחילת דרכם, עמותות ומוסדות ציבור.',
    visual: 'sami',
  },
  {
    title: 'הנהגה שמשפיעה ברמה הלאומית',
    body: 'המומחיות של מזון ייעוץ מס זוכה להכרה הרבה מעבר לכותלי המשרד.\n\nמר שמואל (סמי) מזון, מנכ"ל המשרד: שימש עד לאחרונה כנשיא הארצי של לשכות יועצי המס בישראל.\n\nמר יוסף מזון, דור ההמשך: מכהן כחבר הנהלה מחוז הצפון בלשכת יועצי המס – ומשפיע בפועל על הצעות החוק ודיני המיסים במדינה.',
    visual: 'sami',
  },
  {
