...
export const teamMembers: TeamMember[] = [
  {
    id: 'sami-mazon',
    name: 'סמי מזון',
    role: 'לא חשבונאי - יועץ מס מוסמך, מייסד המשרד',
    description:
      'סמי מזון, יועץ מס מוסמך ותיק עם 50+ שנות ניסיון. מייסד ומנהל המשרד ונשיא לשכת יועצי המס בעבר, מתמחה בייעוץ פרישה, ייעוץ מס ותכנון פיננסי לעסקים וחברות.',
    experience: '50+ שנות ניסיון',
  ...
  },
  {
    ...
    credentials: ['חבר מועצה בלשכת יועצי המס', 'יועץ מס מוסמך'],
